...
function generateMarkdown(data) {
  ...
  *[Questions](#questions)
  ...
  If you have any questions about the repo, ipen an issue and please contact me directly at ${data.email}. You can find more of ${data.repo}'sxxxxxxxxx projects at [${data.link}]
